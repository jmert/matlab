function dly = fftphasedelay(H, samprate, N)
% dly = fftphasedelay(H, samprate, N)
%
% Return the phase delay of the transfer function H.
%
% INPUTS
...
%
% OUTPUTS
%   dly         Phase delay in the transfer function.
%
% EXAMPLE
%
